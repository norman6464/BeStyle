        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/explore" className="text-gray-600 hover:text-blue-600 text-sm">
                  探索
                </Link>
              </li>
              <li>
                <Link to="/trending" className="text-gray-600 hover:text-blue-600 text-sm">
                  トレンド
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/press" className="text-gray-600 hover:text-blue-600 text-sm">
                  プレスリリース
                </Link>
              </li>
            </ul>
          ...
          {/* 規約 */}
          <div>
            <h3 className="font-semibold text-gray-900 mb-4">規約</h3>
            <ul className="space-y-2">
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              © {currentYear} BeStyle. All rights reserved.
            </p>
